...
# Giovanni Baggio
# Allow objects creation / removal through descriptor
        ...
        for yml_document in yml_document_all:
            ...
            if "List" in yml_document["kind"]:
                ...
                for yml_object in yml_document["items"]:
                    ...
                    try:
                        handle_yaml_single_item(
                            k8s_client, yml_object, mode, verbose, namespace, **kwargs)
                ...
                try:
                    handle_yaml_single_item(
                        k8s_client, yml_document, mode, verbose, namespace, **kwargs)
                except client.rest.ApiException as api_exception:
                    api_exceptions.append(api_exception)
